            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index-2.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{asset('assets/images/logo.webp')}}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{asset('assets/images/logo.webp')}}" alt="" height="17">
                        </span>
                    </a>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        --}}
                        <a class="dropdown-item" href="#" onclick="logout_fn()"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Logout</span></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index-2.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{asset('assets/images//logo.webp')}}" alt="" height="60">
                    </span>
                    <span class="logo-lg">
                        <img src="{{asset('assets/images//logo.webp')}}" alt="" height="60">
                    </span>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="menu-title"><i class="ri-more-fill"></i> <span data-key="t-pages">Registrations</span></li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url('index')}}">
                                <i class="ri-account-circle-line"></i> <span data-key="t-widgets">Doctors</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url('index')}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url('index')}}">
                                <i class="ri-file-list-3-line"></i> <span data-key="t-widgets">Pedning Apporvals</span>
                            </a>
                        </li>

                        <li class="menu-title"><i class="ri-more-fill"></i> <span data-key="t-components">Uploads</span></li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url('index')}}">
                                <i class="ri-account-circle-line"></i> <span data-key="t-widgets">Blogs</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url('index')}}">
                                <i class="ri-account-circle-line"></i> <span data-key="t-widgets">Videos</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url('index')}}">
